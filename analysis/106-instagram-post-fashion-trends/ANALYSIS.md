# Template 106 — Instagram post fashion trends
...
|---|---|
| Template number | 106 |
| Pixy name | Instagram post fashion trends |
| Design ID | `cmmcg4mcg0067112wbfkco9gl` |
| Source kind | template |
| Thumbnail URL | https://cdn.pixy.art/54eab0cf-f7d3-484b-bf66-496056e61a47/ |
...
|---|---|---|---|
| Acme | yes | SIL Open Font License 1.1 | `Acme-Regular.ttf` |
...
- **Font family — authoritative — supplied by the Pixy API, not inferred.** Declared: Acme, Anton. These are read from Pixy's API, not inferred from pixels.
...
|---|---|---|---|
| `#231710` | 0.3342 | 0.1007 | 0.5259 |
| `#f2839e` | 0.1829 | 0.6177 | 0.4567 |
| `#c4bfb2` | 0.1512 | 0.7513 | 0.0893 |
| `#bb0fde` | 0.1479 | 0.2643 | 0.9286 |
| `#9b7f63` | 0.1007 | 0.5152 | 0.3618 |
| `#f7ad01` | 0.0832 | 0.6926 | 0.9919 |
...
| Focal point | x=44.7%, y=57.8% (medium confidence) |
...
- **Direction:** to right
- **Brightness range across axis:** 161.6
- **Estimated stops (black alpha):**
  ...
  - 75% -> alpha ~0.294
  - 100% -> alpha ~0.0
- **Grain:** stdDev 12.34, likely textured: True
...
- `assets/fonts/Acme-Regular.ttf` — SIL Open Font License 1.1
