# Template 015 — Instagram post 10
...
|---|---|
| Template number | 015 |
| Pixy name | Instagram post 10 |
| Design ID | `cmrb0pxfy000804jwuhe6c0te` |
| Source kind | template |
| Thumbnail URL | https://cdn.pixy.art/1b0acdad-88d0-4a6d-8682-d929b270782d/ |
...
**Text:** "READY TO TAKE YOUR"  (OCR confidence 0.9119)
...
**Text:** "BUSINESS TO THE NEXT LEVEL?"  (OCR confidence 0.8854)
...
| Property | Value |
|---|---|
| Bounding box (px) | x=276, y=986, w=529, h=32 |
| Normalised | x=25.56%, y=91.3%, w=48.98%, h=2.96% |
| Alignment | center |
| z-order | 103 |
| Rotation | 0° |
| Opacity | 1.0 |
...
|---|---|---|---|
| `#1a1615` | 0.2397 | 0.0918 | 0.2015 |
| `#635547` | 0.1993 | 0.3422 | 0.279 |
| `#f6f3f1` | 0.1771 | 0.9568 | 0.0175 |
| `#e3cfb3` | 0.1482 | 0.8213 | 0.21 |
| `#b09d88` | 0.1375 | 0.6273 | 0.2265 |
| `#4f6ce8` | 0.0981 | 0.4372 | 0.6595 |
...
| Crop mode | cover |
| Focal point | x=51.6%, y=55.0% (medium confidence) |
...
- **Direction:** to bottom
- **Brightness range across axis:** 229.4
- **Estimated stops (black alpha):**
  ...
  - 75% -> alpha ~0.445
  - 100% -> alpha ~0.74
- **Grain:** stdDev 13.16, likely textured: True
